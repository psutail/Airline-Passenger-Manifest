...
use Auth;
use Carbon;
use App\Model\AvailableSeatsAirline;
use App\Model\PassengerBooking;
use App\Model\PassengerList;
use App\Model\AircraftInfo;
use App\Model\Airline;
use App\Model\Destination;
use App\Model\AirPortTerminal;

class BookingScriptActionDefintion implements AirlineBookingProcess
{
    ...
    public function acceptPassengerBooking(Array $customer_information){
        ...
        if($PassengerBooking->id){
            ...
            foreach ($customer_information['details'] => $individual_customer) {
                # code...
